...
Docs: https://docs.medusajs.com/ui/components/table
Import from `@medusajs/ui`. Installed kit is `4.2.1`.

A simple table without DataTable filters.

## When to open this file

Open this file when the view needs `Table`, or a related control from the index row for `table`.
...
Locked list body and detail deployments. Card + divide-y. Checkboxes on list.
