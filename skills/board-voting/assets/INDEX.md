...
Start here before you debate a presentation, layout, or process fork that may already have a vote.

| BV | Title | Decision | Tally | One-liner |
| --- | --- | --- | --- | --- |

No rows yet. After the first persist, append a row. Shape:

`| [0001](./0001-short-title.md) | Short title | Adopt \| Defer \| Reject | N–N–N Adopt | One-line outcome. |`

INDEX Decision MAY read `Adopt (liberum veto)`.
